// scripts/seed-data.js — รูปภาพและรายการสินค้าตัวอย่าง ใช้ร่วมกันระหว่าง seed.js และ seed-shops.js
...
const img = (key, i, opts = {}) => {
  const list = imgs[key]
  const { w = 400, h = 400 } = opts
  return `https://images.unsplash.com/${list[i % list.length]}?w=${w}&h=${h}&fit=crop&q=80`
}
...
module.exports = { img, PRODUCTS_BY_CATEGORY }
